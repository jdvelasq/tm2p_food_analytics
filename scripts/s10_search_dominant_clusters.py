...
PARAMETERS = [
    ...
    #     "MIN_OCC": [8],  # optimal value
    # },
    # {
    #     "YEAR_RANGE": (2024, 2026),
    #     "MIN_OCC": [19],  # optimal value
    # },
    # {
    #     "YEAR_RANGE": (2016, 2026),
    #     "MIN_OCC": [29], # optimal value
    # },
]
...
def analyze_period(period_parameters):
    ...
    for min_occ in period_parameters["MIN_OCC"]:

        print(f"\nProcessing min_occ: {min_occ}")
        ...
        filename = (
            Path("outputs")
            / "search"
            / f"units_by_cluster_{year_start}_{year_end}_with_min_occ_{min_occ}.txt"
        )
